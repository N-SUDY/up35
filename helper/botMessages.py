...
class BotMessage(object):
    common_text = "\n\n<u>If you are facing any problem, so report at @ImDark_Empire</u>"
    ...
    start_msg = f"<b>Hi, I am URL_UploaderBot Created by @SL_BOTS_TM and My Developer is @SL_BOTS_TM.</b>\n{help_msg}"
